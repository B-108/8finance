...
public class Contract {
    ...
    @Column(name = "contract_auto_tran_yn")
    private Boolean contractAutoTranYn;

    @Column(name = "contract_auto_tran_date", columnDefinition = "DATETIME")
    ...
    @Column(name = "contract_maturity_date", columnDefinition = "DATETIME")
